				...
				<form action="PilotRegister" method="post" class="form-group"
					...
					<div class="form-group m-2">
						<label>Email id: </label> <input class="form-control" type="email"
							name="emailid" placeholder="Pilot's Email id" required>
					</div>
					<div class="form-group m-2">
						<label>Name: </label> <input class="form-control" type="text"
							patter="[a-zA-Z ]+" name="name" placeholder="Pilot's Name"
							required>
					</div>
					<div class="form-group m-2">
						<label>Phone Number: </label> <input class="form-control"
							maxlength="10" type="tel" minlength="10" pattern="[0-9]+"
							name="phone" placeholder="Pilot's Phone No." required>
					</div>
					<div class="form-group m-2">
						<label>Experience: </label> <input class="form-control" type="number"
							max="80" min="1" name="experience" placeholder="Pilot's Experience" required>
					</div>
					<div class="form-group m-2">
					...
					<div class="form-group m-2">
						...
						<textarea rows="3" name="address" class="form-control"
							placeholder="Pilot's Address" required></textarea>
					</div>
					<div class="form-group m-2">
