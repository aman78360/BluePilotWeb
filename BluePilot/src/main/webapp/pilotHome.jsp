...
<body>
	...
	<section>
		...
		<section id="courses" class="p-4">
			...
			<%
			TreeSet<String> courseNames = database.getAllCoursesByPilot(emailid);
			...
			<div>
				...
				<p><%=course.get("name")%></p>
				<p>
					<a href="pilotEnrollments.jsp?courseName=<%=course.get("name")%>"
						class="btn btn-outline-warning btn-sm">Enrollments</a>
