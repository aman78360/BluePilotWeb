		...
		<nav class="navbar navbar-expand-sm">
			...
			<div class="collapse navbar-collapse text-white" id="my-navbar">
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item"><a href="allCourses.jsp" class="nav-link">Courses</a>
					</li>
				</ul>
	...
	<section>
		<div class="row">
			<div class="col-5 p-4 bg-warning">
				...
				HashMap pilot = database.getPilotByEmailid(pilot_email);
				database.disconnect();
				%>
				<img src="GetPhoto?emailid=<%=pilot_email%>&userType=pilot"
					style="height: 50px; width: 50px; border-radius: 10px; object-fit: cover; object-position: center;">
				<b>Name:</b>&nbsp;<%=pilot.get("name")%>
				<p>
					<b>Experience:</b>&nbsp;<%=pilot.get("experience")%>
					Years
				</p>
				<p>
					<b>Gender:</b>&nbsp;<%=pilot.get("gender")%></p>
			...
			<div class="col-7 p-4 bg-light">
				...
				<%
				database = new DAO();
				ArrayList<HashMap> conversations = database.getConversation(pilot_email, emailid);
				database.disconnect();

				for (HashMap conversation : conversations) {
				%>
				<div class="py-3 px-3 my-1 bg-dark text-white border border-primary" style = "border-radius: 20px">
					<p>
